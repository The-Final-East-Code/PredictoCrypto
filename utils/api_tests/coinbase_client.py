...
load_dotenv()
API_KEY = os.getenv('COINBASE_API_KEY_2')
API_SECRET = os.getenv('COINBASE_API_SECRET_2')
...
def getProduct(product_id):
    ...
    """
    response = cb_auth(
        Method.GET.value, f'/products/{product_id}')
...
def getProductTicker(product_id):
    """
    Get information on a single product by product ID.
    ...
    """
    response = cb_auth(
        Method.GET.value, f'/products/{product_id}/ticker')
...
def getProductCandles(product_id, start, end, granularity):
    ...
    return cb_auth(Method.GET.value, f'/products/{product_id}/candles', params=params)
